...
struct NES {
    var cpu = CPU()
    var ppu = PPU()
    var apu = APU(sampleRate: samplingFrequency / downSamplingRate, framePeriod: 7458)
...
typealias PulseChannel = NES.APU.PulseChannel
typealias TriangleChannel = NES.APU.TriangleChannel
typealias NoiseChannel = NES.APU.NoiseChannel
typealias DMC = NES.APU.DMC
