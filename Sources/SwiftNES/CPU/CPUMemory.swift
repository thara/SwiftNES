extension NES: ReadWrite {
    ...
    static func write(_ value: UInt8, at address: UInt16, to nes: NES) {
        ...
        nes.cpuMemory.write(value, at: address)
    }
    ...
    static func writeOAM(_ value: UInt8, to nes: NES) {
        ...
        for address in start...(start &+ 0xFF) {
            ...
            nes.cpuMemory.write(data, at: 0x2004)
...
final class CPUMemoryBus: Memory {
    var nes: NES?
    ...
    func read(at address: UInt16) -> UInt8 {
        ...
        case 0x2000...0x3FFF:
            return nes?.ppu.read(from: ppuAddress(address)) ?? 0x00
        case 0x4000...0x4013, 0x4015:
            return 0x00
        case 0x4016, 0x4017:
            return nes?.controllerPort.read(at: address) ?? 0x00
        case 0x4020...0xFFFF:
