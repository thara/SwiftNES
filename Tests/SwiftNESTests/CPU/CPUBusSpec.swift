    ...
    override func spec() {
        ...
        describe("readWord") {
            ...
            it("read 1 word") {
                ...
                expect(bus.readWord(at: 128)).to(equal(0b00000001_00000001))

                bus.write(64, at: 10)
                bus.write(32, at: 11)
                bus.write(255, at: 12)

                expect(bus.readWord(at: 10)).to(equal(0b00100000_01000000))
                expect(bus.readWord(at: 11)).to(equal(0b11111111_00100000))
                expect(bus.readWord(at: 12)).to(equal(0b00000000_11111111))
            }
        }
    }
}
